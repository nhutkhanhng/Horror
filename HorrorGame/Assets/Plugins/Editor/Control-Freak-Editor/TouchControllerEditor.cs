...
private void SelectLayoutBox(int i)
	...
	if ((this.layoutBoxesProp == null) || (this.layoutBoxesProp.arraySize == 0))
		...
		this.layoutBox_alwaysFillProp			= null;
	...
	this.layoutBox_alwaysFillProp			= b.FindPropertyRelative("alwaysFill");
...
private void DrawLayoutBoxEditorSection()
	...
	if ((this.layoutBox_anchorProp != null) && (joy.layoutBoxes != null) && 
		...
		if (DrawCheckBox(this.layoutBox_alwaysFillProp, "Always Fill", "Always scale content to fill this layout box.")) { joy.SetLayoutDirtyFlag(); }
...
private void InitPresetMenu()
	...
	this.AddPreset("iPhone 6", 						1334,	750,	326);
	this.AddPreset("iPhone 6 Plus", 				1920,	1080,	401);
	this.presetMenu.AddSeparator("iOS Tablets");
	this.AddPreset("iPad 1, 2", 					1024, 	768, 	132);
	this.AddPreset("iPad 3, 4, Air, Air 2",			2048, 	1536,	264);
	this.AddPreset("iPad Mini", 					1024, 	768, 	163);
	this.AddPreset("iPad Mini 2, 3",				2048,	1536,	326);
