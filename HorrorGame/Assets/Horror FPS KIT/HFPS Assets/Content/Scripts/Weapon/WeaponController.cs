...
public class WeaponController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {            
            ...
            if (OculusGoInteractManager.Instance.TouchClickInput())
            {
                if (!HFPS_GameManager.Instance.TabButtonPanel.activeSelf)
                {
                    if (!InteractManager.Instance.RayToLayerInteract())
                    {
            ...
            if (OculusGoInteractManager.Instance.TouchLongClickInput())
            {
                if (!HFPS_GameManager.Instance.TabButtonPanel.activeSelf)
                {
    ...
    void FireOneBullet()
    {
        ...
        Ray aim = new Ray(InteractManager.Instance.laserPointer.transform.position, InteractManager.Instance.laserPointer.transform.forward);
