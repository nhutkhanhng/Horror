...
public class ItemIDEditor : Editor {
    ...
    void OnEnable () {
        ...
        QuestID_Prop = serializedObject.FindProperty("QuestID");
        QuestStep_Prop = serializedObject.FindProperty("QuestStep");
	    TotalStep_Prop = serializedObject.FindProperty("TotalStep");
	...
	public override void OnInspectorGUI()
	{
        ...
        switch (type)
        {
            ...
            case ItemID.Type.InventoryItem:
	            ...
	            EditorGUILayout.PropertyField(itemID_Prop, new GUIContent("ItemQuestID:"));
	            EditorGUILayout.PropertyField(QuestID_Prop, new GUIContent("QuestID:"));
	            EditorGUILayout.PropertyField(QuestStep_Prop, new GUIContent("QuestStep:"));
	            EditorGUILayout.PropertyField(TotalStep_Prop, new GUIContent("ToTalStep:"));
                break;
